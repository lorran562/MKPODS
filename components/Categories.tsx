...
const categories = [
  { name: 'Pods descartáveis', image: '/product-v120.jpg', count: '120+ modelos', accent: 'Do compacto ao high-capacity' },
  { name: 'Juices premium', image: '/hero-pod.jpg', count: '80+ sabores', accent: 'Perfis frescos e intensos' },
  { name: 'Kits iniciais', image: '/product-v80.jpg', count: '30+ combinações', accent: 'Comece do seu jeito' },
  { name: 'Acessórios', image: '/product-v55.jpg', count: '50+ itens', accent: 'Detalhes que fazem diferença' },
];
